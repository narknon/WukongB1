#include "BGURideControlTriggerActor.h"
#include "ActorCompContainer.h"
#include "ActorCompContainerCS.h"
#include "BUS_ActorConfigInfoComp.h"
#include "BUS_GuidComp.h"
#include "BUS_RideControlTriggerDataComp.h"
#include "BUS_SaveInitDataComp.h"

ABGURideControlTriggerActor::ABGURideControlTriggerActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_RideControlTriggerDataComp>(TEXT("RideControlTriggerDataComp"));
