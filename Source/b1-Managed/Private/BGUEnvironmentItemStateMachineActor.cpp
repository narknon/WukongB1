#include "BGUEnvironmentItemStateMachineActor.h"
#include "Components/BoxComponent.h"
#include "ActorCompContainer.h"
#include "ActorCompContainerCS.h"
#include "BUS_ActorConfigInfoComp.h"
#include "BUS_EnvironmentItemStateMachineComp.h"
#include "BUS_EnvironmentItemStateMachineDataComp.h"
#include "BUS_GuidComp.h"
#include "BUS_SaveInitDataComp.h"

ABGUEnvironmentItemStateMachineActor::ABGUEnvironmentItemStateMachineActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_EnvironmentItemStateMachineDataComp>(TEXT("EnvironmentItemStateMachineDataComp"));
    ...
    this->EnvironmentItemStateMachineComp = CreateDefaultSubobject<UBUS_EnvironmentItemStateMachineComp>(TEXT("EnvironmentItemStateMachineComp"));
    this->TriggerBox = CreateDefaultSubobject<UBoxComponent>(TEXT("EnvironmentItemStateMachineTriggerBox"));
}
