...
#include "BUS_ModularMgrDataComp.h"
#include "BUS_SaveInitDataComp.h"

ABGUModularMgrActor::ABGUModularMgrActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_ModularMgrDataComp>(TEXT("ModularMgrDataComp"));
    ...
    this->ModularMgrConfigComp = CreateDefaultSubobject<UBUS_ModularMgrConfigComp>(TEXT("ModularMgrConfigComp"));
}

void ABGUModularMgrActor::SpawnModularActors() {
}

void ABGUModularMgrActor::ReceiveDestroyed_Implementation() {
}
