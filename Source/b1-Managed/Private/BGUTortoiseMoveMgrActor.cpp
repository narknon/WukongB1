#include "BGUTortoiseMoveMgrActor.h"
#include "ActorCompContainer.h"
#include "ActorCompContainerCS.h"
#include "BUS_ActorConfigInfoComp.h"
#include "BUS_GuidComp.h"
#include "BUS_SaveInitDataComp.h"
#include "BUS_TortoiseMoveMgrActorConfigComp.h"
#include "BUS_TortoiseMoveMgrActorDataComp.h"

ABGUTortoiseMoveMgrActor::ABGUTortoiseMoveMgrActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_TortoiseMoveMgrActorDataComp>(TEXT("LevelMoveMgrActorDataComp"));
    ...
    this->TortoiseMoveMgrActorConfigComp = CreateDefaultSubobject<UBUS_TortoiseMoveMgrActorConfigComp>(TEXT("TortoiseMoveConfigComp"));
}
