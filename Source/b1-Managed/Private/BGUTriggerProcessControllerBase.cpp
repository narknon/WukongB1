#include "BGUTriggerProcessControllerBase.h"
#include "ActorCompContainer.h"
#include "ActorCompContainerCS.h"
#include "BUS_ActorConfigInfoComp.h"
#include "BUS_GuidComp.h"
#include "BUS_SaveInitDataComp.h"
#include "BUS_TriggerProcessControlComp.h"
#include "BUS_TriggerProcessControllerDataComp.h"

ABGUTriggerProcessControllerBase::ABGUTriggerProcessControllerBase(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_TriggerProcessControllerDataComp>(TEXT("TriggerProcessControllerDataComp"));
    ...
    this->TriggerProcessControlComp = CreateDefaultSubobject<UBUS_TriggerProcessControlComp>(TEXT("TriggerProcessControlSystem"));
}
