...
#include "BED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_WaitAllAssetLoadFinsh : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
