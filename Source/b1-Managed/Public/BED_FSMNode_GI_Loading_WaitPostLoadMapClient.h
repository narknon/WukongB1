...
#include "BED_FSMNode_GI_Loading_WaitPostLoadMapClient.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_WaitPostLoadMapClient : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
