...
#include "BED_BehaviorNode_TriggerAttackStiff_ListenAttacker.generated.h"

UCLASS(Blueprintable)
class UBED_BehaviorNode_TriggerAttackStiff_ListenAttacker : public UBED_BehaviorNode_ListenerTrigger {
    GENERATED_BODY()
public:
