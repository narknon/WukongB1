...
#include "BED_FSMNode_GI_Loading_LoadCharacterViewLevel.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_LoadCharacterViewLevel : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
