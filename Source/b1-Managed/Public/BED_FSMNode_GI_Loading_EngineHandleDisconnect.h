...
#include "BED_FSMNode_GI_Loading_EngineHandleDisconnect.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_EngineHandleDisconnect : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
