...
#include "BED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_ShowHealthyGamingAdviceInStartGame : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
