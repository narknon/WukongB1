...
#include "BED_FSMNode_GI_Loading_LoadingUIWaitUserInput.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_LoadingUIWaitUserInput : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
