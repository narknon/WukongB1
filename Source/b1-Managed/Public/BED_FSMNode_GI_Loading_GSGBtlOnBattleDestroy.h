...
#include "BED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_GSGBtlOnBattleDestroy : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
