...
#include "BED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_WaitStartGamePsoPrecompileFinish : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
