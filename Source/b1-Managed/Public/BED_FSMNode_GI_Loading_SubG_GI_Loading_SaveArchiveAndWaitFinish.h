...
#include "BED_FSMNode_GI_Loading_SubG_GI_Loading_SaveArchiveAndWaitFinish.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_SubG_GI_Loading_SaveArchiveAndWaitFinish : public UBED_FSMNode_SubGraph {
    GENERATED_BODY()
public:
private:
