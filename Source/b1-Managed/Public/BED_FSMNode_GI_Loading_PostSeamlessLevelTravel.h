...
#include "BED_FSMNode_GI_Loading_PostSeamlessLevelTravel.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_PostSeamlessLevelTravel : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
