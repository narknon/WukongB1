...
#include "BED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_ShowAgreementPolicyInStartGame : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
