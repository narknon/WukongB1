...
#include "BED_FSMNode_GI_Loading_CacheArchiveDataForClient.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_CacheArchiveDataForClient : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
