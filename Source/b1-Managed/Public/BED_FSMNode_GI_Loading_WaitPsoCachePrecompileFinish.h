...
#include "BED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_WaitPsoCachePrecompileFinish : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
