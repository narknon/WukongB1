...
#include "BED_FSMNode_GI_Loading_InitLocalPlayerContainer.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_InitLocalPlayerContainer : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
