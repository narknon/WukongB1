...
#include "BED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_ShowArchiveMarkInStartGame : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
