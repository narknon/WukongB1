...
#include "BED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_AdjustPSOCachePrecompileBatch : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
