...
#include "BED_FSMNode_GI_Loading_WaitCheck820DemoGameVersion.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_WaitCheck820DemoGameVersion : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
