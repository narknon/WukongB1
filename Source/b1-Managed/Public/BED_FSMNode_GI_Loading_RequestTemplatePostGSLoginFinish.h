...
#include "BED_FSMNode_GI_Loading_RequestTemplatePostGSLoginFinish.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_RequestTemplatePostGSLoginFinish : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
