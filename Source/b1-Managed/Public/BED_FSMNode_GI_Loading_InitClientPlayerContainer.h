...
#include "BED_FSMNode_GI_Loading_InitClientPlayerContainer.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_InitClientPlayerContainer : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
