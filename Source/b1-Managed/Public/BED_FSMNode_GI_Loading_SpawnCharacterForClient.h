...
#include "BED_FSMNode_GI_Loading_SpawnCharacterForClient.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_SpawnCharacterForClient : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
