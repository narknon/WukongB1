...
#include "BED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_RequestTemplateLoadArchiveData : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
