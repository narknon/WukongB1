...
#include "BED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_ShowGameDisclaimerInStartGame : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
