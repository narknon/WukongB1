...
#include "BED_FSMNode_GI_Loading_WaitUntilGameStateInit.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_WaitUntilGameStateInit : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
