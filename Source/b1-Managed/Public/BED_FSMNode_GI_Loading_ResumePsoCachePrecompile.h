...
#include "BED_FSMNode_GI_Loading_ResumePsoCachePrecompile.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_ResumePsoCachePrecompile : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
