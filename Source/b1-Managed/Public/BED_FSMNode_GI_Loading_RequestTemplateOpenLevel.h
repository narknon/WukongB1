...
#include "BED_FSMNode_GI_Loading_RequestTemplateOpenLevel.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_RequestTemplateOpenLevel : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
