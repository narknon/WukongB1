...
#include "BED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_RequestTemplatePostSaveArchiveFinish : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
