...
#include "BED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_RequestTemplateTravelLevelEnd : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
