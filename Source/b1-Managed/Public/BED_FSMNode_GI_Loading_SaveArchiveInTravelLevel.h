...
#include "BED_FSMNode_GI_Loading_SaveArchiveInTravelLevel.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_SaveArchiveInTravelLevel : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
