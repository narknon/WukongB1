...
#include "BED_FSMNode_GI_Global_InBattleWaitingStartNewGame.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Global_InBattleWaitingStartNewGame : public UBED_FSMNode_GI_GlobalBase {
    GENERATED_BODY()
public:
