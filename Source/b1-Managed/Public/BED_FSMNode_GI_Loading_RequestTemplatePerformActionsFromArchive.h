...
#include "BED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_RequestTemplatePerformActionsFromArchive : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
