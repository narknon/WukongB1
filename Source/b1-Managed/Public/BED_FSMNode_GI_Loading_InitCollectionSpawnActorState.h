...
#include "BED_FSMNode_GI_Loading_InitCollectionSpawnActorState.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_InitCollectionSpawnActorState : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
