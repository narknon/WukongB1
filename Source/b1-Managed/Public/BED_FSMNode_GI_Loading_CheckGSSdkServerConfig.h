...
#include "BED_FSMNode_GI_Loading_CheckGSSdkServerConfig.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_CheckGSSdkServerConfig : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
