...
#include "BED_FSMNode_GI_Loading_FirstStartGameSettings.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_FirstStartGameSettings : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
