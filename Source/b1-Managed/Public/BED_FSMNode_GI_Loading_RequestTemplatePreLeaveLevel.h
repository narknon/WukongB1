...
#include "BED_FSMNode_GI_Loading_RequestTemplatePreLeaveLevel.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_RequestTemplatePreLeaveLevel : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
