...
#include "BED_FSMNode_GI_Loading_PausePsoCachePrecompile.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_PausePsoCachePrecompile : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
