...
#include "BED_FSMNode_GI_Loading_RequestTemplateTravelLevelBegin.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_RequestTemplateTravelLevelBegin : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
