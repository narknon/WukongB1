...
#include "BED_FSMNode_GI_Loading_RequestTemplatePreSaveArchive.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_RequestTemplatePreSaveArchive : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
