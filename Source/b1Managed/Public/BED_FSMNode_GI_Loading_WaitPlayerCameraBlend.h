...
#include "BED_FSMNode_GI_Loading_WaitPlayerCameraBlend.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_WaitPlayerCameraBlend : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
