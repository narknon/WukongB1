...
#include "BED_FSMNode_GI_Loading_NetConectionFailurePreprocess.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_NetConectionFailurePreprocess : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
