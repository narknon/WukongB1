...
#include "BED_FSMNode_GI_Loading_LoadingUIBeginFadeAway.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_LoadingUIBeginFadeAway : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
