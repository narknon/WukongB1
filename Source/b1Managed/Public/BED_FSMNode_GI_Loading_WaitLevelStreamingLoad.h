...
#include "BED_FSMNode_GI_Loading_WaitLevelStreamingLoad.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_WaitLevelStreamingLoad : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
