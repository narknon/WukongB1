...
#include "BED_FSMNode_GI_Loading_RequestTemplateCreateArchiveData.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_RequestTemplateCreateArchiveData : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
