...
#include "BED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_WaitLocalPlayerFillLoginOption : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
