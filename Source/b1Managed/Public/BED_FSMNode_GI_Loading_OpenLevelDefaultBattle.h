...
#include "BED_FSMNode_GI_Loading_OpenLevelDefaultBattle.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_OpenLevelDefaultBattle : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
