...
#include "BED_FSMNode_GI_Loading_ResetGameInstanceData.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_ResetGameInstanceData : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
