...
#include "BED_FSMNode_GI_Loading_NextChapterReqAndArchive.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_NextChapterReqAndArchive : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
