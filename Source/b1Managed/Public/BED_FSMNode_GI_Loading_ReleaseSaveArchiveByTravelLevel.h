...
#include "BED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_ReleaseSaveArchiveByTravelLevel : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
