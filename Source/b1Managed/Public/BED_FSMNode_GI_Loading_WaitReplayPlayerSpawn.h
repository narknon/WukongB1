...
#include "BED_FSMNode_GI_Loading_WaitReplayPlayerSpawn.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_WaitReplayPlayerSpawn : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
