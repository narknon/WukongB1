...
#include "BED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_WaitLocalPlayerStartPlay : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
