...
#include "BED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_PlayGoDownloadIncompleteImpl : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
