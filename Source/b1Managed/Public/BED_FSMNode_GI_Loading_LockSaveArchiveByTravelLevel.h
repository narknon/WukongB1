...
#include "BED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_LockSaveArchiveByTravelLevel : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
