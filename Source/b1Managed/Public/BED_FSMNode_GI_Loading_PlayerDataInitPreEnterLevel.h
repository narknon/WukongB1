...
#include "BED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_PlayerDataInitPreEnterLevel : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
