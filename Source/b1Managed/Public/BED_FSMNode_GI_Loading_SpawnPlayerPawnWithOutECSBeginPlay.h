...
#include "BED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_SpawnPlayerPawnWithOutECSBeginPlay : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
