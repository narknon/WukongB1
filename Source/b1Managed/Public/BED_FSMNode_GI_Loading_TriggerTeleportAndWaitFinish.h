...
#include "BED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_TriggerTeleportAndWaitFinish : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
