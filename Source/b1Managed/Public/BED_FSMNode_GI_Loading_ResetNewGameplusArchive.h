...
#include "BED_FSMNode_GI_Loading_ResetNewGameplusArchive.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_ResetNewGameplusArchive : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
