...
#include "BED_FSMNode_GI_Loading_TeleportTemplateBegin.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_TeleportTemplateBegin : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
