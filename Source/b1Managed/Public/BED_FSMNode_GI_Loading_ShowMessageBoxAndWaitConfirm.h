...
#include "BED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_ShowMessageBoxAndWaitConfirm : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
