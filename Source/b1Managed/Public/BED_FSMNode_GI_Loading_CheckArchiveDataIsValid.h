...
#include "BED_FSMNode_GI_Loading_CheckArchiveDataIsValid.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_CheckArchiveDataIsValid : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
