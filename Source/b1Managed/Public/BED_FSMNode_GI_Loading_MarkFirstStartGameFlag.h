...
#include "BED_FSMNode_GI_Loading_MarkFirstStartGameFlag.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_MarkFirstStartGameFlag : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
