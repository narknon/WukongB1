...
#include "BED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_PlayerTeleportToTemplatetargetPos : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
