...
#include "BED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_WaitImportantAssetLoadFinsh : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
