...
#include "BAIT_Combo.generated.h"

UCLASS(Blueprintable)
class UBAIT_Combo : public UBAIT_Base {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    uint8 CanUpdateComboTargetWhenPursuit: 1;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    uint8 CanCheckCastSkillDuringWholeComboWindow: 1;
    ...
    FString QACalcSkillArray();
    
    UFUNCTION(BlueprintCallable)
    TArray<FString> QACalcTrueComboArray();
