...
#include "BED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_UnlockScopeReplayScrubComplete : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
