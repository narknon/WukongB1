...
#include "BED_FSMNode_GI_Loading_OpenLevelByIdInContext.generated.h"

UCLASS(Blueprintable)
class UBED_FSMNode_GI_Loading_OpenLevelByIdInContext : public UBED_FSMNode_GI_LoadingBase {
    GENERATED_BODY()
public:
private:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FString ContextOptions;
