#include "BGUSpiderOceanMgrActor.h"
...
#include "BUS_SpiderOceanMgrDataComp.h"

ABGUSpiderOceanMgrActor::ABGUSpiderOceanMgrActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_SpiderOceanMgrDataComp>(TEXT("SpiderOceanMgrDataComp"));
    ...
    this->SpiderOceanMgrComp = CreateDefaultSubobject<UBUS_SpiderOceanMgrComp>(TEXT("SpiderOceanMgrComp"));
    this->TriggerBox = CreateDefaultSubobject<UBoxComponent>(TEXT("SpiderOceanTriggerBox"));
}
