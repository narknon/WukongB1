#include "BUS_SeqHelperActorBase.h"
...
#include "BUS_SeqHelperActorDataComp.h"

ABUS_SeqHelperActorBase::ABUS_SeqHelperActorBase(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_SeqHelperActorDataComp>(TEXT("SeqHelperActorDataComp"));
    ...
    this->SeqHelperActorComp = CreateDefaultSubobject<UBUS_SeqHelperActorComp>(TEXT("SeqHelperActorComp"));
}
