#include "BGUSkillSelectHelperActor.h"
#include "ActorCompContainer.h"
#include "ActorCompContainerCS.h"
#include "BUS_ActorConfigInfoComp.h"
#include "BUS_GuidComp.h"
#include "BUS_SaveInitDataComp.h"
#include "BUS_SkillSelectHelperActorDataComp.h"

ABGUSkillSelectHelperActor::ABGUSkillSelectHelperActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_SkillSelectHelperActorDataComp>(TEXT("SkillSelectHelperActorDataComp"));
