#include "BGUGamePlusSpawnActor.h"
#include "ActorCompContainer.h"
#include "ActorCompContainerCS.h"
#include "BUS_ActorConfigInfoComp.h"
#include "BUS_GamePlusSpawnComp.h"
#include "BUS_GamePlusSpawnDataComp.h"
#include "BUS_GuidComp.h"
#include "BUS_SaveInitDataComp.h"

ABGUGamePlusSpawnActor::ABGUGamePlusSpawnActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_GamePlusSpawnDataComp>(TEXT("GamePlusSpawnDataComp"));
    ...
    this->GamePlusSpawnConfigComp = CreateDefaultSubobject<UBUS_GamePlusSpawnComp>(TEXT("GamePlusSpawner"));
}
