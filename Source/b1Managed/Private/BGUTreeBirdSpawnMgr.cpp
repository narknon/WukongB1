...
#include "BUS_TreeBirdSpawnMgrConfigComp.h"
#include "BUS_TreeBirdSpawnMgrDataComp.h"

ABGUTreeBirdSpawnMgr::ABGUTreeBirdSpawnMgr(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->RootComponent = CreateDefaultSubobject<USceneComponent>(TEXT("Root"));
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_TreeBirdSpawnMgrDataComp>(TEXT("DataComp"));
    ...
    this->ConfigComp = CreateDefaultSubobject<UBUS_TreeBirdSpawnMgrConfigComp>(TEXT("ConfigInfoComp"));
