#include "BGUProceduralEnvInteractionActor.h"
...
ABGUProceduralEnvInteractionActor::ABGUProceduralEnvInteractionActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_ProceduralEnvInteractionDataComp>(TEXT("ProceduralEnvInteractionDataComp"));
    ...
    this->ProceduralEnvInteractionConfigComp = CreateDefaultSubobject<UBUS_ProceduralEnvInteractionConfigComp>(TEXT("ProceduralEnvInteractionConfigComp"));
}
