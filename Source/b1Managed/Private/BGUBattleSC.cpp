#include "BGUBattleSC.h"
#include "ActorCompContainer.h"
#include "ActorCompContainerCS.h"
#include "BUS_ActorConfigInfoComp.h"
#include "BUS_BattleSCDataComp.h"
#include "BUS_GuidComp.h"
#include "BUS_MessageDistributionCenter.h"
#include "BUS_SaveInitDataComp.h"

ABGUBattleSC::ABGUBattleSC(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_BattleSCDataComp>(TEXT("BattleSCDataComp"));
    ...
    this->MessageDistributionCenter = CreateDefaultSubobject<UBUS_MessageDistributionCenter>(TEXT("MessageDistributionCenter"));
}
