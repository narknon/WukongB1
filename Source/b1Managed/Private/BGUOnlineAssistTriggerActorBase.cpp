#include "BGUOnlineAssistTriggerActorBase.h"
#include "ActorCompContainer.h"
#include "ActorCompContainerCS.h"
#include "BUS_ActorConfigInfoComp.h"
#include "BUS_GuidComp.h"
#include "BUS_OnlineAssistTriggerConfigComp.h"
#include "BUS_OnlineAssistTriggerDataComp.h"
#include "BUS_SaveInitDataComp.h"

ABGUOnlineAssistTriggerActorBase::ABGUOnlineAssistTriggerActorBase(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_OnlineAssistTriggerDataComp>(TEXT("OnlineAssistTriggerDataComp"));
    ...
    this->OnlineAssistTriggerConfig = CreateDefaultSubobject<UBUS_OnlineAssistTriggerConfigComp>(TEXT("OnlineAssistTriggerConfig"));
}
