#include "BGUDispInteractActor.h"
...
#include "BUS_InteractDrawConfigComp.h"
#include "BUS_SaveInitDataComp.h"

ABGUDispInteractActor::ABGUDispInteractActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_DispInteractBaseDataComp>(TEXT("DispInteractDataComp"));
    ...
    this->AttachTo = NULL;
    this->InteractDrawConfigComp = CreateDefaultSubobject<UBUS_InteractDrawConfigComp>(TEXT("InteractDrawConfigComp"));
}

void ABGUDispInteractActor::BeginPlayCS_Implementation() {
}
