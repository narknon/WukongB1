#include "BGUWanderBGMVolumeActor.h"
#include "ActorCompContainer.h"
#include "ActorCompContainerCS.h"
#include "BUS_ActorConfigInfoComp.h"
#include "BUS_BGMVolumeDataComp.h"
#include "BUS_GuidComp.h"
#include "BUS_SaveInitDataComp.h"
#include "BUS_WanderBGMVolumeComp.h"

ABGUWanderBGMVolumeActor::ABGUWanderBGMVolumeActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_BGMVolumeDataComp>(TEXT("BGMVolumeDataComp"));
    ...
    this->WanderBGMVolumeComp = CreateDefaultSubobject<UBUS_WanderBGMVolumeComp>(TEXT("WanderBGMVolumeComp"));
}
