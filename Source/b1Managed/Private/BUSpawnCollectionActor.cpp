#include "BUSpawnCollectionActor.h"
#include "ActorCompContainer.h"
#include "ActorCompContainerCS.h"
#include "BUS_ActorConfigInfoComp.h"
#include "BUS_GuidComp.h"
#include "BUS_SaveInitDataComp.h"
#include "BUS_SpawnCollectionComp.h"
#include "BUS_SpawnCollectionDataComp.h"

ABUSpawnCollectionActor::ABUSpawnCollectionActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_SpawnCollectionDataComp>(TEXT("CollectionSpawnDataComp"));
    ...
    this->SpawnCollectionComp = CreateDefaultSubobject<UBUS_SpawnCollectionComp>(TEXT("CollectionSpawn"));
}
