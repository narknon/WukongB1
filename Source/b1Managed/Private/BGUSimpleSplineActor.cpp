#include "BGUSimpleSplineActor.h"
...
ABGUSimpleSplineActor::ABGUSimpleSplineActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->SplineComp = CreateDefaultSubobject<USplineComponent>(TEXT("MoveSpline"));
