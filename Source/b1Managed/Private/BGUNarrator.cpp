#include "BGUNarrator.h"
#include "AkComponent.h"
#include "ActorCompContainer.h"
#include "ActorCompContainerCS.h"
#include "BUS_ActorConfigInfoComp.h"
#include "BUS_GuidComp.h"
#include "BUS_NarratorDataComp.h"
#include "BUS_SaveInitDataComp.h"

ABGUNarrator::ABGUNarrator(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->DataComp = CreateDefaultSubobject<UBUS_NarratorDataComp>(TEXT("NarratorDataComp"));
