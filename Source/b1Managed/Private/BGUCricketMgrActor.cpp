#include "BGUCricketMgrActor.h"
#include "ActorCompContainer.h"
#include "ActorCompContainerCS.h"
#include "BUS_ActorConfigInfoComp.h"
#include "BUS_CricketMgrConfigComp.h"
#include "BUS_CricketMgrDataComp.h"
#include "BUS_GuidComp.h"
#include "BUS_SaveInitDataComp.h"

ABGUCricketMgrActor::ABGUCricketMgrActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_CricketMgrDataComp>(TEXT("CricketMgrDataComp"));
    ...
    this->CricketMgrConfigComp = CreateDefaultSubobject<UBUS_CricketMgrConfigComp>(TEXT("CricketMgrConfigComp"));
}
