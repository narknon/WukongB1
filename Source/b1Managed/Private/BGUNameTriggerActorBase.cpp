#include "BGUNameTriggerActorBase.h"
#include "ActorCompContainer.h"
#include "ActorCompContainerCS.h"
#include "BUS_ActorConfigInfoComp.h"
#include "BUS_GuidComp.h"
#include "BUS_NameTriggerConfigComp.h"
#include "BUS_NameTriggerDataComp.h"
#include "BUS_SaveInitDataComp.h"

ABGUNameTriggerActorBase::ABGUNameTriggerActorBase(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_NameTriggerDataComp>(TEXT("NameTriggerDataComp"));
    ...
    this->NameTriggerConfigComp = CreateDefaultSubobject<UBUS_NameTriggerConfigComp>(TEXT("NameTriggerConfigComp"));
}
