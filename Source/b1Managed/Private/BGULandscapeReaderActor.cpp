#include "BGULandscapeReaderActor.h"
...
ABGULandscapeReaderActor::ABGULandscapeReaderActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_ActorBaseDataComp>(TEXT("ActorBaseDataComp"));
    ...
    this->LandscapeReader = CreateDefaultSubobject<ULandscapeReader>(TEXT("LandscapeReader"));
}
