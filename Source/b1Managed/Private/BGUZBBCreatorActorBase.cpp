#include "BGUZBBCreatorActorBase.h"
#include "ActorCompContainer.h"
#include "ActorCompContainerCS.h"
#include "BUS_ActorConfigInfoComp.h"
#include "BUS_GuidComp.h"
#include "BUS_SaveInitDataComp.h"
#include "BUS_ZBBCreatorDataComp.h"

ABGUZBBCreatorActorBase::ABGUZBBCreatorActorBase(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_ZBBCreatorDataComp>(TEXT("ZBBCreatorDataComp"));
    ...
    this->UnitDist = 5000.00f;
}

void ABGUZBBCreatorActorBase::ReceiveTick_Implementation(float DeltaSeconds) {
}
