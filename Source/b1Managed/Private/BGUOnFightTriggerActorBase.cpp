#include "BGUOnFightTriggerActorBase.h"
#include "ActorCompContainer.h"
#include "ActorCompContainerCS.h"
#include "BUS_ActorConfigInfoComp.h"
#include "BUS_GuidComp.h"
#include "BUS_OnFightTriggerConfigComp.h"
#include "BUS_OnFightTriggerDataComp.h"
#include "BUS_SaveInitDataComp.h"

ABGUOnFightTriggerActorBase::ABGUOnFightTriggerActorBase(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_OnFightTriggerDataComp>(TEXT("OnFightTriggerDataComp"));
    ...
    this->OnFightTriggerConfigComp = CreateDefaultSubobject<UBUS_OnFightTriggerConfigComp>(TEXT("OnFightTriggerConfigComp"));
}
