#include "BGUActionTriggerActor.h"
#include "ActorCompContainer.h"
#include "ActorCompContainerCS.h"
#include "BUS_ActionTriggerConfigComp.h"
#include "BUS_ActionTriggerDataComp.h"
#include "BUS_ActorConfigInfoComp.h"
#include "BUS_GuidComp.h"
#include "BUS_SaveInitDataComp.h"

ABGUActionTriggerActor::ABGUActionTriggerActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->ActorCompContainer = CreateDefaultSubobject<UActorCompContainer>(TEXT("ActorCompContainer"));
    this->DataComp = CreateDefaultSubobject<UBUS_ActionTriggerDataComp>(TEXT("ActionTriggerDataComp"));
    ...
    this->ActionTriggerConfigComp = CreateDefaultSubobject<UBUS_ActionTriggerConfigComp>(TEXT("ActionTriggerConfigComp"));
}
