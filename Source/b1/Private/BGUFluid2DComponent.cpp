#include "BGUFluid2DComponent.h"

UBGUFluid2DComponent::UBGUFluid2DComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->toggleSim = true;
...
UTextureRenderTarget2D* UBGUFluid2DComponent::GetVeloDensityTexture() {
    return NULL;
}

UTextureRenderTarget2D* UBGUFluid2DComponent::GetPressureDivergenceTexture() {
    return NULL;
}
