...
#include "BGUFluid2DComponent.generated.h"
...
class B1_API UBGUFluid2DComponent : public UActorComponent {
    GENERATED_BODY()
public:
protected:
...
public:
    UBGUFluid2DComponent(const FObjectInitializer& ObjectInitializer);
