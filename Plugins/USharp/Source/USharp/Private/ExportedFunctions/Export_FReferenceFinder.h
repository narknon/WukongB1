...
CSEXPORT void CSCONV Export_FReferenceFinder_FindReferences(FReferenceFinder* instance, UObject* Object, UObject* ReferencingObject, FProperty* ReferencingProperty)
{
