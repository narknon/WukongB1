...
CSEXPORT csbool CSCONV Export_UEnum_SetEnums(UEnum* instance, TArray<FName>& InNames, TArray<int64>& InValues, UEnum::ECppForm InCppForm, EEnumFlags InFlags = EEnumFlags::None, csbool bAddMaxKeyIfMissing = false)
{
	...
	return instance->SetEnums(Names, InCppForm, InFlags, !!bAddMaxKeyIfMissing);
}
