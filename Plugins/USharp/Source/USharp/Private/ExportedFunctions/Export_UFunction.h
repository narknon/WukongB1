...
CSEXPORT FProperty* CSCONV Export_UFunction_Get_FirstPropertyToInit(UFunction* instance)
{
	return instance->FirstPropertyToInit;
}

CSEXPORT void CSCONV Export_UFunction_Set_FirstPropertyToInit(UFunction* instance, FProperty* value)
{
...
CSEXPORT FProperty* CSCONV Export_UFunction_GetReturnProperty(UFunction* instance)
{
