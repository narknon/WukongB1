...
CSEXPORT void CSCONV Export_UObject_PostInterpChange(UObject* instance, FProperty* PropertyThatChanged)
{
	instance->PostInterpChange(PropertyThatChanged);
}

#if WITH_EDITOR
CSEXPORT void CSCONV Export_UObject_PreEditChange(UObject* instance, FProperty* PropertyAboutToChange)
{
...
CSEXPORT csbool CSCONV Export_UObject_CanEditChange(UObject* instance, const FProperty* InProperty)
{
...
CSEXPORT void CSCONV Export_UObject_PostReloadConfig(UObject* instance, class FProperty* PropertyThatWasLoaded)
{
...
CSEXPORT void CSCONV Export_UObject_LoadConfig(UObject* instance, UClass* ConfigClass, const FString& Filename, uint32 PropagationFlags, class FProperty* PropertyToLoad)
{
	instance->LoadConfig(ConfigClass, *Filename, PropagationFlags, PropertyToLoad);
}

CSEXPORT void CSCONV Export_UObject_ReloadConfig(UObject* instance, UClass* ConfigClass, const FString& Filename, uint32 PropagationFlags, class FProperty* PropertyToLoad)
{
