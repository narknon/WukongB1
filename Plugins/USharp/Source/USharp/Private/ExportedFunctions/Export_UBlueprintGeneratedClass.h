...
CSEXPORT FStructProperty* CSCONV Export_UBlueprintGeneratedClass_Get_UberGraphFramePointerProperty(UBlueprintGeneratedClass* instance)
{
	return instance->UberGraphFramePointerProperty;
}

CSEXPORT void CSCONV Export_UBlueprintGeneratedClass_Set_UberGraphFramePointerProperty(UBlueprintGeneratedClass* instance, FStructProperty* value)
{
...
CSEXPORT void CSCONV Export_UBlueprintGeneratedClass_UnbindDynamicDelegatesForProperty(UBlueprintGeneratedClass* instance, UObject* InInstance, const FObjectProperty* InObjectProperty)
{
