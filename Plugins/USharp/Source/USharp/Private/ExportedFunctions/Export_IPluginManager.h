...
#if !IS_MONOLITHIC
CSEXPORT csbool CSCONV Export_IPluginManager_CheckModuleCompatibility(IPluginManager* instance, TArray<FString>& OutIncompatibleModules, TArray<FString>& OutIncompatibleEngineModules)
{
	return instance->CheckModuleCompatibility(OutIncompatibleModules, OutIncompatibleEngineModules);
}
#endif
