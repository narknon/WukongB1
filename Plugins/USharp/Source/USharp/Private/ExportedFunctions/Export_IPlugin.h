...
CSEXPORT csbool CSCONV Export_IPlugin_IsEnabledByDefault(IPlugin* instance, bool bAllowEnginePluginsEnabledByDefault)
{
	return instance->IsEnabledByDefault(bAllowEnginePluginsEnabledByDefault);
}
