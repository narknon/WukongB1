...
CSEXPORT FProperty* CSCONV Export_UStruct_Get_PropertyLink(UStruct* instance)
{
	return instance->PropertyLink;
}

CSEXPORT void CSCONV Export_UStruct_Set_PropertyLink(UStruct* instance, FProperty* value)
{
	instance->PropertyLink = value;
}

CSEXPORT FProperty* CSCONV Export_UStruct_Get_RefLink(UStruct* instance)
{
	return instance->RefLink;
}

CSEXPORT void CSCONV Export_UStruct_Set_RefLink(UStruct* instance, FProperty* value)
{
	instance->RefLink = value;
}

CSEXPORT FProperty* CSCONV Export_UStruct_Get_DestructorLink(UStruct* instance)
{
	return instance->DestructorLink;
}

CSEXPORT void CSCONV Export_UStruct_Set_DestructorLink(UStruct* instance, FProperty* value)
{
	instance->DestructorLink = value;
}

CSEXPORT FProperty* CSCONV Export_UStruct_Get_PostConstructLink(UStruct* instance)
{
	return instance->PostConstructLink;
}

CSEXPORT void CSCONV Export_UStruct_Set_PostConstructLink(UStruct* instance, FProperty* value)
{
	instance->PropertyLink = value;
}

CSEXPORT TArray<UObject*>& CSCONV Export_UStruct_Get_ScriptAndPropertyObjectReferences(UStruct* instance)
{
	return instance->ScriptAndPropertyObjectReferences;
}

CSEXPORT void CSCONV Export_UStruct_Set_ScriptAndPropertyObjectReferences(UStruct* instance, TArray<UObject*>& value)
{
	instance->ScriptAndPropertyObjectReferences = value;
}
...
CSEXPORT FProperty* CSCONV Export_UStruct_FindPropertyByName(UStruct* instance, const FName& Name)
{
...
CSEXPORT void CSCONV Export_UStruct(RegisterFunc registerFunc)
{
	...
	REGISTER_FUNC(Export_UStruct_Get_ScriptAndPropertyObjectReferences);
	REGISTER_FUNC(Export_UStruct_Set_ScriptAndPropertyObjectReferences);
