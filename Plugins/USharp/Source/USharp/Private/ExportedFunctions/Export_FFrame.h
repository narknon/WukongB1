...
CSEXPORT void CSCONV Export_FFrame_StepExplicitProperty(FFrame* instance, void*const Result, FProperty* Property)
{
...
CSEXPORT int32 CSCONV Export_FFrame_ReadVariableSize(FFrame* instance, FProperty** ExpressionField)
{
